...
| S3  | A request came in            | In Home, paste the whole of `marcus-offline-mode.md` and send. On the question card, pick No, the decision stands.                                                                                                                                | A plain question that Qale recognises as a request and pulls Handle a commitment in for, an inbound ask decoded into a note, a clarifying question raised by a contradiction with a live decision, a sales-voice reply. |

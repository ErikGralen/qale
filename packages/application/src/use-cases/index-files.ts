...
const FOLDER_PURPOSE: Record<NoteType, string> = {
  ...
  research: 'what Qale worked out: the case for a problem, a competitor scan',
  about: 'what is true about you and the company: the product, how it is built, who owns what',

/**
 * Theme "evidence heat" (PLAN-V2 §3.1) — themes (the durable hubs where
 * insights accrete into something worth solving) are ranked by how much
 * evidence they carry and how fresh it is: count + newest-evidence date, not a
 * decayed score. Evidence accrues even on a `wont-do` stance (we keep the why).
 */

...
against. The answer was data control and auditability. We countered with the EU-only region,
the audit log, ISO 27001 and the DPA, and sent all of it the same week. Antti will take it to
their security board, and was honest that he won't push our case if the board says no.
